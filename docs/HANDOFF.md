...
3. **스테이지 수식어**(야근 러시·감사 기간·정전·납기 압박·단체 민원, 300단계 중 90단계)를 `abSystems.mjs` 의 `modifier` 항목으로 넣어 뒀다 — **아직 한 번도 안 돌렸다.** 다음 세션에서 `node scripts/abSystems.mjs modifier` 로 확인할 것.
