...
## 5. 남은 일 (우선순위 순)
1. **수치 실플레이 검증**: 수식 대응(4초·60% 감소) · 탱커 가로채기(30~58%) · 인사 복구(확정 1 + 확률) · 스카우트(하루 3회) · 역할 상시 효과 · ★ 스킬 2차 효과. 전부 계산과 시뮬로는 맞췄지만 **손으로 해 본 적이 없다.**
2. **0x72 보스 3종의 손그림화**: 악마·좀비·오우거는 사무실 소품으로 정체를 얻었지만 몸통은 여전히 던전 생물이고 픽셀 밀도도 3px 로 다르다. 나머지 여섯처럼 손그림 사무기기로 옮기면 9종이 완전히 한 결이 된다.
