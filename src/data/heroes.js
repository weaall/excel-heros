...
export const SKILLS = Object.freeze({
  ...
  heal:   { name: '웰니스 데이', desc: '파티 전체가 **잃은 체력**의 {p}% 회복',   cooldown: 12 },
  ult:    { name: '경영 지시',  desc: '모든 적에게 ×{p} 피해 + 1.2초 기절', cooldown: 14 },
  burn:    { name: '긴급 패치',   desc: '모든 적에게 4초간 초당 ×{p} 화상 피해',          cooldown: 12, duration: 4 },
  barrier: { name: '조항의 방패', desc: '6초간 파티 총 체력의 {p}%만큼 피해를 대신 흡수',      cooldown: 16, duration: 6 },
  haste:   { name: '스프린트',    desc: '5초간 파티 공격 속도 +{p}%',                     cooldown: 14, duration: 5 },
  execute: { name: '저격 보고',   desc: '단일 대상 ×{p} 피해 · 대상 HP 30% 미만이면 2배', cooldown: 9 },
  cleanse: { name: '스트레스 해소', desc: '파티 {p}% 회복 · 둔화 해제 · 5초간 공격 속도 +35%', cooldown: 14, duration: 5 },
  revive:  { name: '인사 복구',     desc: '쓰러진 동료를 HP {p}%로 복귀 — 1명은 확정, 추가 인원은 ★에 따른 확률(최대 3명) · 쓰러진 동료가 없으면 「재고용 보장」: 25초 안에 처음 쓰러지는 한 명이 HP {p}%로 즉시 복귀', cooldown: 20 },
  drain:   { name: '성과 회수',     desc: '모든 적에게 ×{p} 피해 · 입힌 피해의 40%만큼 파티 회복 (1회 최대 HP 25%까지)', cooldown: 13 },
...
export const HEROES = [
  ...
  { id: 'barista',    name: '카페 바리스타', grade: 'D', role: 'healer', trait: 'regen',     skill: { type: 'heal',   power: 30 },  look: { hair: 'bun', acc: 'coffee', acc2: 'badge' , prop: 'apron' }, palette: { H: '#c97b4a', B: '#6d4c41', P: '#3e2723', W: '#ffcc80' } },
  ...
  { id: 'pivot',      name: '피벗 매니저',    grade: 'C', role: 'tank',   trait: 'rally',    skill: { type: 'buff',   power: 33.8 },  look: { hair: 'bald', acc: 'beard', acc2: 'tie' , prop: 'suspenders' }, palette: { H: '#4a3b2a', B: '#00b894', P: '#0b6b4b', W: '#a3ffd6' } },
  ...
  { id: 'hr_jung',    name: '인사팀 정대리',  grade: 'C', role: 'healer', trait: 'regen',    skill: { type: 'heal',   power: 36 },  look: { hair: 'long', acc: 'clipboard', acc2: 'earring' }, palette: { H: '#5c2e0a', B: '#7bed9f', P: '#2d3436', W: '#ff7675' } },
  ...
  { id: 'ga_lead',    name: '총무팀장',      grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 4.96, name: '비품 창고 성벽' },  look: { hair: 'grey', acc: 'beard', acc2: 'lanyard' , prop: 'files' }, palette: { H: '#b2bec3', B: '#2b7cd3', P: '#1b3a6b', W: '#dfe6e9' } },
  { id: 'welfare',    name: '복지팀장',      grade: 'B', role: 'healer', trait: 'lifesteal', skill: { type: 'heal',   power: 42 },  look: { hair: 'bob', acc: 'flower', acc2: 'scarf' }, palette: { H: '#b33939', B: '#a3c4ff', P: '#2f3640', W: '#ff9ff3' } },
  // A (3) -------------------------------------------------------------------
  ...
  { id: 'coo',        name: 'COO',           grade: 'A', role: 'tank',   trait: 'rally',     skill: { type: 'buff',   power: 47.2 },  look: { hair: 'short', acc: 'beard', acc2: 'badge' , prop: 'briefcase' }, palette: { H: '#636e72', B: '#8e44ad', P: '#2c2c54', W: '#dfe6e9' } },
  // S (2) -------------------------------------------------------------------
  { id: 'ceo',        name: '대표이사',      grade: 'S', role: 'ranged', trait: 'focus',     skill: { type: 'ult', power: 3.4 },      look: { hair: 'side', acc: 'sunglasses', acc2: 'tie' , prop: 'briefcase' }, palette: { H: '#f5f6fa', B: '#d4a017', P: '#2f3640', W: '#fbc531' } },
  { id: 'chairman',   name: '회장님',        grade: 'S', role: 'tank',   trait: 'rally',     skill: { type: 'ult', power: 2.45 },      look: { hair: 'bald', acc: 'crown', acc2: 'beard' , prop: 'cane' }, palette: { H: '#dcdde1', B: '#e1b12c', P: '#353b48', W: '#f5f6fa' } },
  // 16차 추가 (8) ---------------------------------------------------------------
  ...
  { id: 'legal_yoon', name: '법무팀 윤대리', grade: 'C', role: 'tank',   trait: 'focus',     skill: { type: 'barrier', power: 5.55, name: '조항의 방패' },  look: { hair: 'long', acc: 'glasses', prop: 'files' },            palette: { H: '#2c2c54', B: '#a29bfe', P: '#2d3436', W: '#dfe6e9' } },
  ...
  { id: 'founder',    name: '창업자',        grade: 'S', role: 'melee',  trait: 'crit',      skill: { type: 'ult', power: 2.99 },    look: { hair: 'long', acc: 'glasses', prop: 'hoodie' },          palette: { H: '#2d3436', B: '#00b894', P: '#2d3436', W: '#f5f6fa' } },
  // 22차 추가 (6, 여성 5) ---------------------------------------------------------
  ...
  { id: 'nurse_han',  name: '사내 간호사',   grade: 'C', role: 'healer', trait: 'regen',     skill: { type: 'heal',   power: 33.6 },  look: { hair: 'bun', acc: 'badge', prop: 'clipboard' },           palette: { H: '#6c5ce7', B: '#dfe6e9', P: '#2d3436', W: '#00cec9' } },
  ...
  { id: 'chro',       name: 'CHRO',          grade: 'A', role: 'healer', trait: 'rally',     skill: { type: 'revive', power: 68.8, name: '인사 복구' },  look: { hair: 'side', acc: 'earring', acc2: 'badge', prop: 'files' }, palette: { H: '#2d3436', B: '#e84393', P: '#2d3436', W: '#ffeaa7' } },
  { id: 'cso',        name: '전략실장 서하늘', grade: 'S', role: 'ranged', trait: 'rally',   skill: { type: 'ult',     power: 2.99, name: '전략 브리핑' }, look: { hair: 'long', acc: 'earring', prop: 'tablet' },        palette: { H: '#c8b6ff', B: '#f5f6fa', P: '#2f3640', W: '#8c7ae6' } },
  ...
  { id: 'union_chief', name: '노조위원장 강철', grade: 'S', role: 'tank',  trait: 'sturdy',  skill: { type: 'barrier', power: 9.78,  name: '단체 협약' },     look: { hair: 'spiky', acc: 'headband', prop: 'megaphone' },   palette: { H: '#1e272e', B: '#c23616', P: '#2f3640', W: '#f5f6fa' } },
  ...
  { id: 'intern_min',    name: '인턴 민지',       grade: 'D', role: 'healer', trait: 'lucky',     skill: { type: 'heal',    power: 26.4,  name: '응원 메시지' },  look: { hair: 'twin', acc: 'ribbon', prop: 'notebook' },     palette: { H: '#c98a7a', B: '#f7d6e0', P: '#3b3b4f', W: '#ffffff' } },
  { id: 'security_yang', name: '보안팀 양사원',   grade: 'D', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 3.5,   name: '출입 통제' },    look: { hair: 'ponytail', acc: 'badge', prop: 'radio' },      palette: { H: '#1f1f2a', B: '#1f2a44', P: '#1f2a44', W: '#8fb8e8' } },
  ...
  { id: 'reception_go',  name: '안내데스크 고은', grade: 'C', role: 'healer', trait: 'regen',     skill: { type: 'buff',    power: 32.4,  name: '안내 방송' },    look: { hair: 'long', acc: 'headset', prop: 'mic' },          palette: { H: '#7a4a2f', B: '#ffb7a1', P: '#3b3b3b', W: '#ffffff' } },
  ...
  { id: 'secretary_yun', name: '비서실장 윤서',   grade: 'B', role: 'healer', trait: 'rally',     skill: { type: 'buff',    power: 37.8,  name: '일정 조정' },    look: { hair: 'bun', acc: 'earring', prop: 'planner' },       palette: { H: '#151515', B: '#2f3640', P: '#151515', W: '#d4a017' } },
  { id: 'logistics_bae', name: '물류팀장 배철',   grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 6.28,   name: '팔레트 벽' },    look: { hair: 'short', acc: 'gloves', prop: 'boxes' },        palette: { H: '#3b2a1a', B: '#7f8c8d', P: '#2f3640', W: '#f39c12' } },
  ...
  { id: 'labor_atty',    name: '노무사 서린',      grade: 'A', role: 'healer', trait: 'lifesteal', skill: { type: 'revive',  power: 75,  name: '부당해고 취소' }, look: { hair: 'long', acc: 'glasses', prop: 'files' },        palette: { H: '#4e342e', B: '#eceff1', P: '#90a4ae', W: '#ff8a65' } },
  ...
  { id: 'cco',           name: 'CCO 미소',        grade: 'A', role: 'healer', trait: 'lifesteal', skill: { type: 'heal',    power: 48,  name: '고객 감동' },    look: { hair: 'bob', acc: 'earring', prop: 'phone' },         palette: { H: '#f4a9c8', B: '#ff8a80', P: '#2f3640', W: '#ffffff' } },
  ...
  { id: 'chairwoman', name: '이사장',        grade: 'S', role: 'tank',   trait: 'sturdy',    skill: { type: 'ult', power: 2.72 },    look: { hair: 'long', acc: 'crown', acc2: 'earring', prop: 'cane' }, palette: { H: '#f5f6fa', B: '#2d3436', P: '#2d3436', W: '#d4a017' } },
];
