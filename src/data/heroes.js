...
export const HEROES = [
  ...
  { id: 'ga_lead',    name: '총무팀장',      grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 3.4, name: '비품 창고 성벽' },  look: { hair: 'grey', acc: 'beard', acc2: 'lanyard' , prop: 'files' }, palette: { H: '#b2bec3', B: '#2b7cd3', P: '#1b3a6b', W: '#dfe6e9' } },
  ...
  // S (2) -------------------------------------------------------------------
  { id: 'ceo',        name: '대표이사',      grade: 'S', role: 'ranged', trait: 'focus',     skill: { type: 'ult', power: 2.5 },      look: { hair: 'side', acc: 'sunglasses', acc2: 'tie' , prop: 'briefcase' }, palette: { H: '#f5f6fa', B: '#d4a017', P: '#2f3640', W: '#fbc531' } },
  { id: 'chairman',   name: '회장님',        grade: 'S', role: 'tank',   trait: 'rally',     skill: { type: 'ult', power: 1.8 },      look: { hair: 'bald', acc: 'crown', acc2: 'beard' , prop: 'cane' }, palette: { H: '#dcdde1', B: '#e1b12c', P: '#353b48', W: '#f5f6fa' } },
  // 16차 추가 (8) ---------------------------------------------------------------
  ...
  { id: 'legal_yoon', name: '법무팀 윤대리', grade: 'C', role: 'tank',   trait: 'focus',     skill: { type: 'barrier', power: 3.8, name: '조항의 방패' },  look: { hair: 'long', acc: 'glasses', prop: 'files' },            palette: { H: '#2c2c54', B: '#a29bfe', P: '#2d3436', W: '#dfe6e9' } },
  ...
  { id: 'founder',    name: '창업자',        grade: 'S', role: 'melee',  trait: 'crit',      skill: { type: 'ult', power: 2.2 },    look: { hair: 'long', acc: 'glasses', prop: 'hoodie' },          palette: { H: '#2d3436', B: '#00b894', P: '#2d3436', W: '#f5f6fa' } },
  // 22차 추가 (6, 여성 5) ---------------------------------------------------------
  ...
  { id: 'cso',        name: '전략실장 서하늘', grade: 'S', role: 'ranged', trait: 'rally',   skill: { type: 'ult',     power: 2.2, name: '전략 브리핑' }, look: { hair: 'long', acc: 'earring', prop: 'tablet' },        palette: { H: '#c8b6ff', B: '#f5f6fa', P: '#2f3640', W: '#8c7ae6' } },
  ...
  { id: 'union_chief', name: '노조위원장 강철', grade: 'S', role: 'tank',  trait: 'sturdy',  skill: { type: 'barrier', power: 6.7,  name: '단체 협약' },     look: { hair: 'spiky', acc: 'headband', prop: 'megaphone' },   palette: { H: '#1e272e', B: '#c23616', P: '#2f3640', W: '#f5f6fa' } },
  ...
  { id: 'security_yang', name: '보안팀 양사원',   grade: 'D', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 2.4,   name: '출입 통제' },    look: { hair: 'ponytail', acc: 'badge', prop: 'radio' },      palette: { H: '#1f1f2a', B: '#1f2a44', P: '#1f2a44', W: '#8fb8e8' } },
  ...
  { id: 'logistics_bae', name: '물류팀장 배철',   grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 4.3,   name: '팔레트 벽' },    look: { hair: 'short', acc: 'gloves', prop: 'boxes' },        palette: { H: '#3b2a1a', B: '#7f8c8d', P: '#2f3640', W: '#f39c12' } },
  ...
  { id: 'chairwoman', name: '이사장',        grade: 'S', role: 'tank',   trait: 'sturdy',    skill: { type: 'ult', power: 2 },    look: { hair: 'long', acc: 'crown', acc2: 'earring', prop: 'cane' }, palette: { H: '#f5f6fa', B: '#2d3436', P: '#2d3436', W: '#d4a017' } },
];
