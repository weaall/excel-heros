...
export const HEROES = [
  ...
  { id: 'barista',    name: '카페 바리스타', grade: 'D', role: 'healer', trait: 'regen',     skill: { type: 'heal',   power: 45 },  look: { hair: 'bun', acc: 'coffee', acc2: 'badge' , prop: 'apron' }, palette: { H: '#c97b4a', B: '#6d4c41', P: '#3e2723', W: '#ffcc80' } },
  ...
  { id: 'hr_jung',    name: '인사팀 정대리',  grade: 'C', role: 'healer', trait: 'regen',    skill: { type: 'heal',   power: 54 },  look: { hair: 'long', acc: 'clipboard', acc2: 'earring' }, palette: { H: '#5c2e0a', B: '#7bed9f', P: '#2d3436', W: '#ff7675' } },
  ...
  { id: 'welfare',    name: '복지팀장',      grade: 'B', role: 'healer', trait: 'lifesteal', skill: { type: 'heal',   power: 63 },  look: { hair: 'bob', acc: 'flower', acc2: 'scarf' }, palette: { H: '#b33939', B: '#a3c4ff', P: '#2f3640', W: '#ff9ff3' } },
  // A (3) -------------------------------------------------------------------
  ...
  { id: 'nurse_han',  name: '사내 간호사',   grade: 'C', role: 'healer', trait: 'regen',     skill: { type: 'heal',   power: 50.4 },  look: { hair: 'bun', acc: 'badge', prop: 'clipboard' },           palette: { H: '#6c5ce7', B: '#dfe6e9', P: '#2d3436', W: '#00cec9' } },
  ...
  { id: 'intern_min',    name: '인턴 민지',       grade: 'D', role: 'healer', trait: 'lucky',     skill: { type: 'heal',    power: 39.6,  name: '응원 메시지' },  look: { hair: 'twin', acc: 'ribbon', prop: 'notebook' },     palette: { H: '#c98a7a', B: '#f7d6e0', P: '#3b3b4f', W: '#ffffff' } },
  ...
  { id: 'cco',           name: 'CCO 미소',        grade: 'A', role: 'healer', trait: 'lifesteal', skill: { type: 'heal',    power: 72,  name: '고객 감동' },    look: { hair: 'bob', acc: 'earring', prop: 'phone' },         palette: { H: '#f4a9c8', B: '#ff8a80', P: '#2f3640', W: '#ffffff' } },
