...
export const HEROES = [
  ...
  { id: 'reception_go',  name: '안내데스크 고은', grade: 'C', role: 'healer', trait: 'regen',     skill: { type: 'heal',    power: 30,  name: '안내 방송' },    look: { hair: 'long', acc: 'headset', prop: 'mic' },          palette: { H: '#7a4a2f', B: '#ffb7a1', P: '#3b3b3b', W: '#ffffff' } },
  { id: 'trainer_seok',  name: '사내 강사 석훈',  grade: 'C', role: 'tank',   trait: 'rally',     skill: { type: 'buff',    power: 22,  name: '아침 조회' },    look: { hair: 'short', acc: 'whistle', prop: 'clipboard' },   palette: { H: '#2b2b2b', B: '#e67e22', P: '#2c3e50', W: '#ffffff' } },
  ...
  { id: 'cdo',           name: 'CDO 하린',        grade: 'A', role: 'ranged', trait: 'crit',      skill: { type: 'burn',    power: 1.2, name: '데이터 폭주' },  look: { hair: 'long', acc: 'earring', prop: 'tablet' },       palette: { H: '#151515', B: '#1e272e', P: '#1e272e', W: '#00d2ff' } },
