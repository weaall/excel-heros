...
export const HEROES = [
  ...
  { id: 'macro',      name: '매크로 엔지니어', grade: 'C', role: 'melee', trait: 'splash',   skill: { type: 'sweep',  power: 1.5 }, look: { hair: 'spiky', acc: 'headset' , prop: 'hoodie' },         palette: { H: '#1a1a1a', B: '#1abc9c', P: '#2d3436', W: '#00cec9' } },
  ...
  { id: 'audit_han',  name: '감사팀 한대리',  grade: 'C', role: 'melee',  trait: 'focus',    skill: { type: 'strike', power: 4 },   look: { hair: 'side', acc: 'sunglasses', acc2: 'tie' , prop: 'magnifier' }, palette: { H: '#3d3d3d', B: '#2ecc71', P: '#192a56', W: '#dcdde1' } },
  // B (4) -------------------------------------------------------------------
  ...
  { id: 'dev_lead',   name: '개발팀장',      grade: 'B', role: 'melee',  trait: 'swift',     skill: { type: 'strike', power: 4.5 }, look: { hair: 'curly', acc: 'headset', acc2: 'coffee' , prop: 'hoodie' }, palette: { H: '#1e272e', B: '#0984e3', P: '#2d3436', W: '#00cec9' } },
  { id: 'ga_lead',    name: '총무팀장',      grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'buff',   power: 30 },  look: { hair: 'grey', acc: 'beard', acc2: 'lanyard' , prop: 'files' }, palette: { H: '#b2bec3', B: '#2b7cd3', P: '#1b3a6b', W: '#dfe6e9' } },
  ...
  { id: 'cto',        name: 'CTO',           grade: 'A', role: 'melee',  trait: 'crit',      skill: { type: 'strike', power: 5 },   look: { hair: 'spiky', acc: 'sunglasses', acc2: 'coffee' , prop: 'watch' }, palette: { H: '#2d3436', B: '#a29bfe', P: '#2d3436', W: '#00b894' } },
  ...
  { id: 'pr_yoo',     name: '홍보팀 유주임', grade: 'C', role: 'melee',  trait: 'swift',     skill: { type: 'sweep',  power: 1.4 }, look: { hair: 'bob', acc: 'earring', prop: 'phone' },             palette: { H: '#e17055', B: '#ffffff', P: '#2d3436', W: '#e84393' } },
  ...
  { id: 'lab_park',   name: '연구소 박박사', grade: 'B', role: 'ranged', trait: 'crit',      skill: { type: 'sweep',  power: 1.9 }, look: { hair: 'long', acc: 'glasses', prop: 'laptop' },            palette: { H: '#b2bec3', B: '#f5f6fa', P: '#2d3436', W: '#0984e3' } },
