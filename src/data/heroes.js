...
export const HEROES = [
  ...
  { id: 'barista',    name: '카페 바리스타', grade: 'D', role: 'healer', trait: 'regen',     skill: { type: 'heal',   power: 32.5 },  look: { hair: 'bun', acc: 'coffee', acc2: 'badge' , prop: 'apron' }, palette: { H: '#c97b4a', B: '#6d4c41', P: '#3e2723', W: '#ffcc80' } },
  ...
  { id: 'hr_jung',    name: '인사팀 정대리',  grade: 'C', role: 'healer', trait: 'regen',    skill: { type: 'heal',   power: 39 },  look: { hair: 'long', acc: 'clipboard', acc2: 'earring' }, palette: { H: '#5c2e0a', B: '#7bed9f', P: '#2d3436', W: '#ff7675' } },
  ...
  { id: 'ga_lead',    name: '총무팀장',      grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 4.2, name: '비품 창고 성벽' },  look: { hair: 'grey', acc: 'beard', acc2: 'lanyard' , prop: 'files' }, palette: { H: '#b2bec3', B: '#2b7cd3', P: '#1b3a6b', W: '#dfe6e9' } },
  { id: 'welfare',    name: '복지팀장',      grade: 'B', role: 'healer', trait: 'lifesteal', skill: { type: 'heal',   power: 45.5 },  look: { hair: 'bob', acc: 'flower', acc2: 'scarf' }, palette: { H: '#b33939', B: '#a3c4ff', P: '#2f3640', W: '#ff9ff3' } },
  // A (3) -------------------------------------------------------------------
  ...
  // S (2) -------------------------------------------------------------------
  { id: 'ceo',        name: '대표이사',      grade: 'S', role: 'ranged', trait: 'focus',     skill: { type: 'ult', power: 3.1 },      look: { hair: 'side', acc: 'sunglasses', acc2: 'tie' , prop: 'briefcase' }, palette: { H: '#f5f6fa', B: '#d4a017', P: '#2f3640', W: '#fbc531' } },
  { id: 'chairman',   name: '회장님',        grade: 'S', role: 'tank',   trait: 'rally',     skill: { type: 'ult', power: 2.3 },      look: { hair: 'bald', acc: 'crown', acc2: 'beard' , prop: 'cane' }, palette: { H: '#dcdde1', B: '#e1b12c', P: '#353b48', W: '#f5f6fa' } },
  // 16차 추가 (8) ---------------------------------------------------------------
  ...
  { id: 'cleaner',    name: '미화 여사님',   grade: 'D', role: 'healer', trait: 'lucky',     skill: { type: 'cleanse', power: 21, name: '싹 치우기' },  look: { hair: 'bun', acc: 'badge', prop: 'mop' },                 palette: { H: '#636e72', B: '#fab1a0', P: '#2d3436', W: '#ffeaa7' } },
  ...
  { id: 'legal_yoon', name: '법무팀 윤대리', grade: 'C', role: 'tank',   trait: 'focus',     skill: { type: 'barrier', power: 4.8, name: '조항의 방패' },  look: { hair: 'long', acc: 'glasses', prop: 'files' },            palette: { H: '#2c2c54', B: '#a29bfe', P: '#2d3436', W: '#dfe6e9' } },
  ...
  { id: 'founder',    name: '창업자',        grade: 'S', role: 'melee',  trait: 'crit',      skill: { type: 'ult', power: 2.7 },    look: { hair: 'long', acc: 'glasses', prop: 'hoodie' },          palette: { H: '#2d3436', B: '#00b894', P: '#2d3436', W: '#f5f6fa' } },
  // 22차 추가 (6, 여성 5) ---------------------------------------------------------
  ...
  { id: 'nurse_han',  name: '사내 간호사',   grade: 'C', role: 'healer', trait: 'regen',     skill: { type: 'heal',   power: 36.4 },  look: { hair: 'bun', acc: 'badge', prop: 'clipboard' },           palette: { H: '#6c5ce7', B: '#dfe6e9', P: '#2d3436', W: '#00cec9' } },
  ...
  { id: 'cso',        name: '전략실장 서하늘', grade: 'S', role: 'ranged', trait: 'rally',   skill: { type: 'ult',     power: 2.8, name: '전략 브리핑' }, look: { hair: 'long', acc: 'earring', prop: 'tablet' },        palette: { H: '#c8b6ff', B: '#f5f6fa', P: '#2f3640', W: '#8c7ae6' } },
  { id: 'ai_lead',    name: 'AI연구소장 루나', grade: 'S', role: 'healer', trait: 'regen',   skill: { type: 'cleanse', power: 48,  name: '시스템 복구' },   look: { hair: 'long', acc: 'glasses', prop: 'laptop' },         palette: { H: '#9ff3e6', B: '#ffffff', P: '#1e272e', W: '#00cec9' } },
  { id: 'union_chief', name: '노조위원장 강철', grade: 'S', role: 'tank',  trait: 'sturdy',  skill: { type: 'barrier', power: 8.4,  name: '단체 협약' },     look: { hair: 'spiky', acc: 'headband', prop: 'megaphone' },   palette: { H: '#1e272e', B: '#c23616', P: '#2f3640', W: '#f5f6fa' } },
  ...
  { id: 'intern_min',    name: '인턴 민지',       grade: 'D', role: 'healer', trait: 'lucky',     skill: { type: 'heal',    power: 28.6,  name: '응원 메시지' },  look: { hair: 'twin', acc: 'ribbon', prop: 'notebook' },     palette: { H: '#c98a7a', B: '#f7d6e0', P: '#3b3b4f', W: '#ffffff' } },
  { id: 'security_yang', name: '보안팀 양사원',   grade: 'D', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 3,   name: '출입 통제' },    look: { hair: 'ponytail', acc: 'badge', prop: 'radio' },      palette: { H: '#1f1f2a', B: '#1f2a44', P: '#1f2a44', W: '#8fb8e8' } },
  ...
  { id: 'logistics_bae', name: '물류팀장 배철',   grade: 'B', role: 'tank',   trait: 'sturdy',    skill: { type: 'barrier', power: 5.4,   name: '팔레트 벽' },    look: { hair: 'short', acc: 'gloves', prop: 'boxes' },        palette: { H: '#3b2a1a', B: '#7f8c8d', P: '#2f3640', W: '#f39c12' } },
  ...
  { id: 'cco',           name: 'CCO 미소',        grade: 'A', role: 'healer', trait: 'lifesteal', skill: { type: 'heal',    power: 52,  name: '고객 감동' },    look: { hair: 'bob', acc: 'earring', prop: 'phone' },         palette: { H: '#f4a9c8', B: '#ff8a80', P: '#2f3640', W: '#ffffff' } },
  ...
  { id: 'chairwoman', name: '이사장',        grade: 'S', role: 'tank',   trait: 'sturdy',    skill: { type: 'ult', power: 2.5 },    look: { hair: 'long', acc: 'crown', acc2: 'earring', prop: 'cane' }, palette: { H: '#f5f6fa', B: '#2d3436', P: '#2d3436', W: '#d4a017' } },
];
