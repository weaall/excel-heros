...
export const HEROES = [
  ...
  { id: 'founder',    name: '창업자',        grade: 'S', role: 'melee',  trait: 'crit',      skill: { type: 'ult', power: 3.5 },    look: { hair: 'long', acc: 'glasses', prop: 'hoodie' },          palette: { H: '#2d3436', B: '#00b894', P: '#2d3436', W: '#f5f6fa' } },
  // 22차 추가 (6, 여성 5) ---------------------------------------------------------
