...
export const BOSSES = [
  ...
  { id: 'boss_audit',    name: '감사팀 악어',       shape: 'ticket', palette: { ...BOSS_PALETTE, M: '#16a085', D: '#0e6252' }, pattern: 'fire',  hp: 1.15, atk: 1.05, speed: 100, interval: 2.1, specials: [{ every: 3, kind: 'volley', name: '전수 감사!', desc: '3번째 공격: 불덩이 3연발 (각 60%)' }, { every: 7, kind: 'slow', name: '소명 요구!', desc: '7번째 공격: 4초간 파티 공격 속도 -30%' }], desc: '3번째 공격마다 전수 감사(불덩이 3연발) · 7번째 공격은 소명 요구로 파티를 느리게' },
  { id: 'boss_target',   name: '실적 고릴라',       shape: 'ticket', palette: { ...BOSS_PALETTE, M: '#7f5539', D: '#4a2f1c' }, pattern: 'stomp', hp: 1.3,  atk: 1.1,  speed: 95,  interval: 2.5, specials: [{ every: 3, kind: 'stomp', name: '실적 압박!', desc: '3번째 공격: 전원 50%' }, { every: 5, kind: 'sweep', name: '목표 상향!', desc: '5번째 공격: 앞 두 명 휩쓸기 (90%)' }], desc: '3번째 공격마다 전원 발구르기 · 5번째 공격은 앞 두 명 휩쓸기' },
  { id: 'boss_approval', name: '결재 코끼리',       shape: 'ticket', palette: { ...BOSS_PALETTE, M: '#5d6d7e', D: '#2c3e50' }, pattern: 'sweep', hp: 1.5,  atk: 0.95, speed: 80,  interval: 2.8, specials: [{ every: 4, kind: 'throw', name: '반려!', desc: '4번째 공격: 맨 뒤 영웅에게 140%' }, { every: 6, kind: 'stomp', name: '재상신 요구!', desc: '6번째 공격: 전원 50%' }], desc: '느리지만 단단하다 · 4번째 공격은 맨 뒤로 서류 반려 · 6번째는 전원 재상신' },
];
