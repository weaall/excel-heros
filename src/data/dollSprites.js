...
export const DOLLS = {
  ...
  cfo:        { hair: 'short', hairColor: '#e8e8e8', skin: 'light', outfit: 'suit', top: '#5b2c6f', shirt: '#f4f4f4', bottom: 'pants', bottomColor: '#472257', acc: ['glasses', 'tie:#d4a017', 'trim:#d4a017'], halo: '#f1f1f1' }, // art: silver hair, deep purple three-piece, gold chain
  ...
  chro:       { hair: 'long', hairColor: '#151515', skin: 'fair', outfit: 'suit', top: '#f0ece2', shirt: '#f4f4f4', bottom: 'skirt', bottomColor: '#7b8b5a', acc: ['trim:#d4a017', 'earring'], halo: '#ffe0f0' }, // art: black wavy hair, cream jacket with gold, olive skirt
