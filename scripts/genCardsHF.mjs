...
const BG_BY_ID = {
  ...
  parttime: 'bright reception desk, lobby, flowers', guard: 'office building lobby, security desk, glass doors', barista: 'cozy cafe interior, espresso machine, warm light', courier: 'plain office interior, daylight', contract: 'open-plan office, plants, bright window', cleaner: 'quiet office corridor, plain daylight',
...
const OUTFIT_BY_ID = {
  ...
  staff_park: 'white shirt sleeves rolled, loosened tie, lanyard', guard: 'navy security uniform, cap, radio', courier: 'orange delivery uniform, cap, holding a small parcel at chest height', vlookup: 'vest over shirt, glasses, pen',
