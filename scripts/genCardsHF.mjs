...
const BG_BY_ID = {
  ...
  parttime: 'bright reception desk, lobby, flowers', guard: 'office building lobby, security desk, glass doors', barista: 'cozy cafe interior, espresso machine, warm light', courier: 'plain office loading door, parcels, flat daylight', contract: 'open-plan office, plants, bright window', cleaner: 'quiet office corridor, plain daylight',
  helpdesk: 'ordinary office IT corner, shelves and cables, plain daylight', macro: 'developer workspace, multiple monitors, code on screen, neon accents', dev_lead: 'developer workspace, monitors, night city window', cto: 'bright high-tech office, glass walls, holographic screens, daylight',
...
const GRADE = { D: 'plain everyday office wear, ordinary and unremarkable, no special effects, no glow, flat even daylight, calm natural expression, beautiful detailed face', C: 'business casual, id card, neat and tidy, soft daylight, beautiful detailed face', B: 'team leader look, refined details, soft light particles, beautiful detailed face', A: 'executive, luxurious details, gold accents, sparkles, light particles, beautiful detailed face', S: 'legendary executive, gold trim, sparkles, light particles, glowing, beautiful detailed face' };
...
const OUTFIT_BY_ID = {
  ...
  hr_jung: 'teal blazer, white blouse, pencil skirt, earrings', acct_lead: 'black turtleneck, high-waist trousers, glasses', welfare: 'pastel knit sweater, long skirt, scarf', coo: 'elegant tailored navy pantsuit with gold buttons and a thin gold chain, silk blouse, sleek side-swept bob, sharp confident smile, holding a slim tablet, gold accents, light particles, sparkles, beautiful detailed face',
...
export function prompt(def, profileId, skin = null) {
  ...
  return `${describe(def, profileId, skin?.prompt ?? null)}, looking at viewer, face fully visible, eyes visible, head in frame, medium shot, upper body, waist up, face focus, soft even front lighting, bright face, ${haloTag(def.grade)}, ${bg} (soft, out of focus), ${STYLE_TAGS}, masterpiece, best quality, very aesthetic, absurdres`;
}
