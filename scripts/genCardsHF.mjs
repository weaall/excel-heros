...
const STYLE_TAGS = 'blue archive style, thin halo ring floating above the head, small halo, centered composition, character centered in frame, flat color, cel shading, clean lineart, anime coloring, vivid pastel colors, soft blurred background, muted simple background, depth of field, character focus';
