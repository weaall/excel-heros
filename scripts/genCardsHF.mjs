...
const GRADE = { D: 'casual office wear, beautiful detailed face', C: 'business casual, id card, beautiful detailed face', B: 'team leader look, refined details, soft light particles, beautiful detailed face', A: 'executive, luxurious details, gold accents, sparkles, light particles, beautiful detailed face', S: 'legendary executive, gold trim, sparkles, light particles, glowing, beautiful detailed face' };
...
const OUTFIT_BY_ID = {
  ...
  cfo: 'deep purple three-piece suit with a gold pocket watch chain, silver hair swept back, thin gold-rimmed glasses, sharp calculating smile, floating golden numbers and charts around him', cto: 'black turtleneck under a tailored charcoal blazer, spiky black hair, tinted glasses pushed up on his head, confident smirk, holographic cyan code panels floating around him', chairman: 'golden formal suit, cane, crown, beard', founder: 'white and gold founder jacket worn open over a hoodie, short black hair, thin glasses, arms loosely crossed, a constellation of glowing startup icons rising behind him, visionary confident gaze', sales_kang: 'sharp navy suit, red tie, briefcase',
