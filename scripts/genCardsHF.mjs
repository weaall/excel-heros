...
const BG_BY_ID = {
  ...
  hr_jung: 'bright HR office, bookshelves, plants', welfare: 'office break room, snacks, warm light', design_lead: 'design studio, drawing tablets, colorful posters', pm_lead: 'meeting room, sticky notes on glass wall', cmo: 'rooftop terrace at sunset, neon billboards, bokeh city lights',
...
const OUTFIT_BY_ID = {
  ...
  pm_lead: 'denim jacket over blouse, sticky notes, lanyard', design_lead: 'colorful paint-splattered smock, beret, drawing tablet', cmo: 'stylish scarlet blazer over white top, long wavy hair, sunglasses pushed up on head, statement gold earrings, playful wink, confetti and bokeh light particles, sparkles, beautiful detailed face',
