...
const BG_BY_ID = {
  ...
  parttime: 'bright reception desk, lobby, flowers', guard: 'office building lobby, security desk, glass doors', barista: 'cozy cafe interior, espresso machine, warm light', courier: 'office mail room with shelves of parcels, daylight from a window', contract: 'open-plan office, plants, bright window', cleaner: 'quiet office corridor, plain daylight',
  helpdesk: 'office IT desk with a monitor and cable shelves, daylight from a window', macro: 'developer workspace, multiple monitors, code on screen, neon accents', dev_lead: 'developer workspace, monitors, night city window', cto: 'bright high-tech office, glass walls, holographic screens, daylight',
